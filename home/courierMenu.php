...
$billno = mt_rand(100000, 999999); // You can adjust the range as needed
        ...
        <div style="overflow-x:auto;">
            ...
            <th colspan="4" style="text-align: center;background-color:cyan; font-family:Berlin Sans FB; width: 140px; height: 60px;">Fill The Details Of Sender & Receiver</th>
                ...
                <tr>
                    ...
                    <!-- Display the generated bill number -->
                    <td>Payment Id:</td>
                    <td><input type="text" name="billno" value="<?php echo $billno; ?>" readonly></td>
                </tr>
                <tr>
